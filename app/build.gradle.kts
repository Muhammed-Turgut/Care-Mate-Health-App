...
dependencies {
    ...
    kapt("androidx.hilt:hilt-compiler:1.2.0") // 🔥 eksik parça
    ...
    //MediaPipe Pose bunu hasstanın duruş bozukluklarını analiz etmekte kullanacağım.
    implementation ("com.google.mediapipe:solution-core:0.10.0")
    implementation ("com.google.mediapipe:solution-pose:0.10.0")
